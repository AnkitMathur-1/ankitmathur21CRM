		...
		<div class="content">
			<form action="/saveData" method="post">
				<div class="user-details">
					...
					<div class="input-box">
						<span class="details">DoB</span> <input type="text"
					...
					<div class="input-box">
						<span class="details">Email ID</span> <input type="text"
							placeholder="Enter your emailId" required>
					</div>
					<div class="input-box">
						<span class="details">Company</span> <input type="text"
            ...
            <input type="text" placeholder="Enter your company" required>
					...
					<div class="input-box">
						<span class="details">Employees</span> <select name="select">
					...
					<div class="input-box">
						<span class="details">UserID</span> <input type="text"
