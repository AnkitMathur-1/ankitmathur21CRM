    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/accountData" method = "post">
                ...
                <input type="text" name="annualRevenue" placeholder="Annual Revenue">
                ...
                <input type="text" name="billingStateProvince" placeholder="Billing State/Province">
                <input type="text" name="billingZipPostalCode" placeholder="Billing Zip/Postal Code">
                <input type="text" name="billingCountry" placeholder="Billing Country">
                <input type="text" name="shippingAddress" placeholder="Shipping Address">
                <input type="text" name="shippingStreet" placeholder="Shipping Street">
                <input type="text" name="shippingCity" placeholder="Shipping City">
                <input type="text" name="shippingStateProvince" placeholder="Shipping State/Province">
                <input type="text" name="shippingZipPostalCode" placeholder="Shipping Zip/Postal Code">
                <input type="text" name="shippingCountry" placeholder="Shipping Country">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/contactsData" method = "post">
                ...
                <select name="sal" id="dropdown_name">
                    <option value="Name:Salutation">Name:Salutation</option>
                    <option value="mr.">Mr.</option>
                    <option value="ms">Ms.</option>
                    <option value="mrs">Mrs.</option>
                ...
                <input type="text" name="ac_name" placeholder="Account Name">
                <input type="text" name="email" placeholder="Email">
                <input type="text" name="title" placeholder="Title">
                <input type="text" name = "report"placeholder="Report To"><!--entry and auto search-->
                <h3>Address Information</h3>
                <input type="text " name="mail_address" placeholder="Mailing Address">
                <input type="text " name="mail_street" placeholder="Mailing Street">
                <input type="text " name = "mail_city" placeholder="Mailing City">
                <input type="text " name = "mail_state"  placeholder="Mailing State/Province">
                <input type="text " name = "mail_postalCode" placeholder="Mailing Zip/Postal Code">
                <input type="text " name = "mail_country" placeholder="Mailing Country">
                <input type="text " name = "other_address" placeholder="Other Address">
                <input type="text " name = "other_street" placeholder="Other Street">
                <input type="text " name = "other_city placeholder="Other City">
                <input type="text " name = "other_state" placeholder="Other State/Province">
                <input type="text " name = "other_postal"  placeholder="Other Zip/Postal Code">
                ...
                <input type="text " name = "adv" placeholder="Advertisement">
                <input type="text " name = "ot_phone" placeholder="Other phone">
                <input type="text " name = "birDate" placeholder="Birthdate"> <!--Date picker-->
                
                <input type="text " name = "assist_phone" placeholder="Asst. Phone">
                <input type="text " name = "assist" placeholder="Assistance">
                <input type="text" name = "descr_info" placeholder = "Description information">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/caseData" method = "post">
                ...
                <input type="text" name="case_num"placeholder="Case Number"><!--should be auto generated-->
                <input type="text" name="contact_name" placeholder="Contact Name"><!--autocomplete on typing contact-->
                <input type="text" name="Account_name"placeholder="Account Name"><!--autocomplete on typing account-->
                ...
                <select name="status" id="dropdown_status">
                 ...
                 <select name="type" id="dropdown_type">
                  ...
                  <select name="case_origin" id="dropdown_caseorigin">
                  ...
                  <select name="case_reason" id="dropdown_casereason">
                  ...
                  <input type="text" name = "descrip" placeholder="Description">
                  <input type="text" name = "int_com" placeholder="Internal Comments">
